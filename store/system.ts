...
> = {
  ...
  reform: {
    ...
    navTitle: '深圳市数学学会中小学数学教师论文竞赛平台' ,
    navTitleEn: 'Shenzhen Mathematics Middle and Primary School Math Teacher Paper Competition Platform',
    fontClass: 'system-font-reform', // 教师论文竞赛系统字体，在 index.css 中定义 .system-font-reform
    homeBadge: '中小学数学教师论文竞赛进行中',
    homeBadgeEn: 'Middle and Primary School Math Teacher Paper Competition Open',  
    heroTitle: '展现数学思维，分享教研智慧',
    heroTitleEn: 'Enhance Mathematics Art, Share Teaching Wisdom',
    heroSub: '欢迎来到深圳市数学学会中小学数学教师论文竞赛平台。在这里，您可以提交教学研究成果，参与高水平论文竞赛。',
  ...
  contest: {
    name: '数智创新竞赛',
    nameEn: 'Math & AI Innovation Contest',
    navTitle: '深圳市数学学会数智创新竞赛平台',
    navTitleEn: 'Shenzhen Mathematics Society Math & AI Innovation Contest Platform',
    fontClass: 'font-sans',
    homeBadge: '数智创新竞赛报名进行中',
    homeBadgeEn: 'Math & AI Innovation Contest Registration Open',
    heroTitle: '挑战数学极限，展现竞技风采',
    heroTitleEn: 'Challenge Mathematical Limits, Showcase Competitive Excellence',
    heroSub: '欢迎来到深圳市数学学会湾区数学与智能+科技创新竞赛平台。在这里，您可以浏览赛题、组队报名、提交解题方案，参与高水平数学竞赛。',
    heroSubEn: 'Welcome to the Bay Area Math & AI Innovation Contest Platform. Browse problems, form teams, submit solutions, and compete at the highest level.',
