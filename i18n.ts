...
export const translations = {
  zh: {
    ...
    login: {
      ...
      titlePlaceholder: '如：高级教师、在校本科生、硕士研究生',
      gradePlaceholder: '选填，如：大四、硕士二年级',
      ...
      passwordRequirement: '密码要求：至少6位，包含大写字母、小写字母、特殊字符中的至少两种',
      passwordWeak: '密码强度不符合要求',
      forgotPassword: '忘记密码？',
      resetPassword: '重置密码',
  ...
  en: {
    ...
    login: {
      ...
      titlePlaceholder: 'e.g., Senior Teacher, Undergraduate, Graduate',
      gradePlaceholder: 'Optional, e.g., Senior, 2nd year Master',
      ...
      passwordRequirement: 'Password requirement: At least 6 characters, including at least two of: uppercase, lowercase, special characters',
